...
base_savedir = '/disk/xray99/tl3/proj-convex-UQ/outputs/new_UQ_results/wavelets_new_reg_strength'
...
# Wavelet parameters
reg_params = [1e2] # [5e2, 5e1, 1e3, 5e3, 1e4, 5e4]
wavs_list = ['db8']
levels = 4
...
for img_name in img_name_list:
    ...
    for it_1 in range(len(reg_params)):
        ...
        grad_prior = lambda _x, lmbd: (
            torch.clone(_x) - prox_prior_cai(_x, lmbd)
        ) / lmbd 
        # Define posterior potential
